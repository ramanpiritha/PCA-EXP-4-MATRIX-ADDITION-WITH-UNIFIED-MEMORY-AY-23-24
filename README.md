...
### With MemSet
<img width="620" height="100" alt="image" src="https://github.com/user-attachments/assets/d0f7133b-71d3-4fa8-8b1f-bcb93391d987" />

### Without MemSet

<img width="630" height="101" alt="image" src="https://github.com/user-attachments/assets/337a6a7a-8758-4b10-93cb-adb92b0cd555" />

## RESULT:

Thus the program has been executed by using unified memory. It is observed that removing memset function has given 0.007354(sec) more time.
